...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::insert("INSERT INTO possede_tag values(NULL, 1, 1, NULL, NULL)");
        DB::insert("INSERT INTO possede_tag values(NULL, 1, 2, NULL, NULL)");

        DB::insert("INSERT INTO possede_tag values(NULL, 2, 1, NULL, NULL)");
        DB::insert("INSERT INTO possede_tag values(NULL, 2, 2, NULL, NULL)");

        DB::insert("INSERT INTO possede_tag values(NULL, 3, 1, NULL, NULL)");
        DB::insert("INSERT INTO possede_tag values(NULL, 3, 4, NULL, NULL)");

        DB::insert("INSERT INTO possede_tag values(NULL, 4, 2, NULL, NULL)");
        DB::insert("INSERT INTO possede_tag values(NULL, 4, 3, NULL, NULL)");

        DB::insert("INSERT INTO possede_tag values(NULL, 5, 2, NULL, NULL)");
        DB::insert("INSERT INTO possede_tag values(NULL, 5, 4, NULL, NULL)");
    }
}
